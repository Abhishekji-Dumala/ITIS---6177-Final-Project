...
const options = {
    swaggerDefinition: {
      info: {
        ...
        version: "1.0",
        description: "SYSTEM INTEGRATION FINAL PROJECT - Abhishekji Dumala",
      },
      host: "167.71.14.20:4080",
      basePath: "/",
    },
    apis: ["./app.js"],
  };
...
//endpoint for create to convert text to speech
app.post("/create",urlencodedParser,[],(req, res) => {
    ...
    if (req.body.TEXT){
        ...
        target_text = "Enter the text which you want to convert it into speech?"
    }
 ...
 *            TEXT:
 *                type: string
 *                example: enter text what you want to listen
 *            PITCH:
 *                type: number
 *                example: 1
 *            SPEEKING_SPEED:
...
app.listen(port, () => {
  ...
  console.log(`Example app listening at http://http://167.71.14.20:${port}`);
  });
